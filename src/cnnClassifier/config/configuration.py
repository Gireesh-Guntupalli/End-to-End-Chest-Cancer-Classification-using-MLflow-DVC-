...
class ConfigurationManager:
    def __init__(
        ...
        )  ##creates directories for artifacts which is artifact_root.
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            mlflow_uri="https://dagshub.com/Gireesh-Guntupalli/End-to-End-Chest-Cancer-Classification-using-MLflow-DVC-.mlflow",
